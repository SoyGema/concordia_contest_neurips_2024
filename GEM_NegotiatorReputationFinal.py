...
change default observations to 24h
"""
...
def build_agent(
  ...
  paranoia = agent_components.constant.Constant(
      state=(
          f'{agent_name} wants to achive the best outcome for themselves while'
          ' mantaining good relationships with others.They aim to balance'
